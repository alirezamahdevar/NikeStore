...
import com.example.nikestorefinal.feature.main.common.VIEW_TYPE_LARGE
import com.example.nikestorefinal.feature.main.common.VIEW_TYPE_SMALL
...
class ProductListActivity : NikeActivity(),ProductListAdapter.ProductEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewTypeChangeBtn.setOnClickListener {
            if (productListAdapter.viewType == VIEW_TYPE_SMALL) {
                viewTypeChangeBtn.setImageResource(R.drawable.ic_view_type_large)
                productListAdapter.viewType = VIEW_TYPE_LARGE
                gridLayoutManager.spanCount = 1
                productListAdapter.notifyDataSetChanged()
            } else {
                viewTypeChangeBtn.setImageResource(R.drawable.ic_grid)
