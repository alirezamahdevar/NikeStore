...
import com.example.nikestorefinal.data.CartItem
import com.example.nikestorefinal.feature.main.auth.AuthActivity
import com.example.nikestorefinal.feature.main.product.ProductDetailActivity
import com.example.nikestorefinal.feature.main.shipping.ShippingActivity
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.emptyStateLiveData.observe(viewLifecycleOwner) {
            if (it.mustShow) {
                ...
                emptyState?.let { view ->
                    emptyState.empty_state_message_tv.text = getString(it.messageResId)
                    emptyState.empty_state_cta_btn.visibility =
